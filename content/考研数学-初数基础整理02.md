...
#### __自比性问题的关键是判断符号，因此需要掌握以下几个表达式__
...
__02-21：已知abc<0, a+b+c= 0, 则 |a|/a + b/|b| + |c|/c + |ab|/ab + bc/|bc| + |ca|/ca = ?：__ <br>
A. 0       B.1       C.-1       D.2        E.以上均不正确

<div align=center>
  <span>解析如下：</span> <br><br>
  <img width="350" src="../pics/02-21.jpg"/>
</div>
<br>

#### __一些图像类归类总结__

__02-22：对形如：y=|x-a| + |x-b|形式的图像：__ <br>

<div align=center> 
  <span>总结如下：</span> <br><br>
  <img width="350" src="../pics/02-22.jpg"/>
</div>
<br>

__02-23：对形如：y=|x-a| - |x-b|形式的图像：__ <br>

<div align=center>
  <span>总结如下：</span> <br><br>
  <img width="350" src="../pics/02-23.jpg"/>
</div>
<br>

__02-24：对形如：y=|x-a| + |x-b| + |x-c| 形式的图像：__ <br>

<div align=center>
  <span>总结如下：</span> <br><br>
  <img width="350" src="../pics/02-24.jpg"/>
</div>